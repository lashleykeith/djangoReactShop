...
# Getting Started with Create the Django App
   ...
   - In settings.py write 'base.apps.BaseConfig',
   - In views.py write JsonResponse
   - Make urls.py in the base folder
   - In the urls.py in the backend main project add a pay to the basefolder
